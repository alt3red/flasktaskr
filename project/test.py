...
class AllTests(unittest.TestCase):
    ...
    def test_users_can_login(self):
        self.register('Raz', 'raz@email.com', 'python', 'python')
        response = self.login('Raz', 'python')
    ...
    def test_form_is_present_on_registration_page(self):
    ...
    def test_user_registration(self):
        ...
        response = self.register('Raz', 'raz@email.com', 'python', 'python')
    ...
    def test_not_logged_in_users_cannot_access_tasks_page(self):
        ...
        self.assertIn(b'You need to login to access this page.', response.data)
    ...
    def test_users_can_complete_tasks(self):
        ...
        self.assertIn(b'The task has been marked as complete.', response.data)
    ...
    def test_users_cannot_complete_tasks_that_are_not_created_by_them(self):
        ...
        response = self.app.get("complete/1/", follow_redirects=True)
        self.assertNotIn(
            b'The task has been marked as complete.', response.data
        )
